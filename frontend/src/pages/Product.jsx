...
const Product = () => {
  ...
  return productData ? (
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <button onClick={()=>addToCart(productData._id,size)} className="bg-red-500 text-white px-8 py-3 text-sm active:bg-gray-700">ADD TO CART</button>
  ...
  <p>
    ...
    E-commerce websites have gained immense popularity due to their convenience and the global reach they offer.
  </p>
  <p>
